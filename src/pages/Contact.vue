            ...
            <div class="space-y-8">
              ...
              <div class="bg-white rounded-lg shadow-lg p-8">
                ...
                <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                  <!-- Facebook -->
                  <a href="#" class="flex items-center space-x-3 space-x-reverse p-4 bg-blue-50 rounded-lg hover:bg-blue-100 transition-colors">
                  ...
                  <!-- Instagram -->
                  <a href="#" class="flex items-center space-x-3 space-x-reverse p-4 bg-gradient-to-r from-purple-50 to-pink-50 rounded-lg hover:from-purple-100 hover:to-pink-100 transition-colors">
                  ...
                  <!-- WhatsApp -->
                  <a href="#" class="flex items-center space-x-3 space-x-reverse p-4 bg-green-50 rounded-lg hover:bg-green-100 transition-colors">
                  ...
                  <!-- Twitter/X -->
                  <a href="#" class="flex items-center space-x-3 space-x-reverse p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                  ...
                  <!-- YouTube -->
                  <a href="#" class="flex items-center space-x-3 space-x-reverse p-4 bg-red-50 rounded-lg hover:bg-red-100 transition-colors">
