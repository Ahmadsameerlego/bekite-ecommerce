          ...
          <div class="w-full max-w-2xl mx-auto px-2">
            <div class="bg-white/95 backdrop-blur-md rounded-3xl shadow-2xl border border-white/20 p-4 sm:p-6 md:p-4">
              ...
              <div class="mt-6">
                <button 
                  @click="performSearch"
                  class="md:w-1/2 mx-auto bg-gradient-to-r from-orange-500 to-red-500 text-white py-2 sm:py-4 px-3 md:py-2 rounded-2xl font-bold text-base sm:text-lg hover:from-orange-600 hover:to-red-600 transition-all shadow-lg flex items-center justify-center gap-3"
                >
